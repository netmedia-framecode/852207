<?php require_once("../controller/desa.php");
$_SESSION["project_wisata_mollo_utara"]["name_page"] = "Desa";
                        ...
                        <form action="" method="post">
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <input type="text" name="desa" value="<?= $data['desa'] ?>" class="form-control" id="desa" required>
                            </div>
                          </div>
